const printablesCategories = {
  ...
  'Art & Design': {'id': '13', 'path': ['Art & Design'], 'pathIds': ['13']},
  ...
  'Costumes & Accessories': {'id': '76', 'path': ['Costumes & Accessories'], 'pathIds': ['76']},
  ...
  'Fashion': {'id': '17', 'path': ['Fashion'], 'pathIds': ['17']},
  ...
  'Gadgets': {'id': '21', 'path': ['Gadgets'], 'pathIds': ['21']},
  ...
  'Healthcare': {'id': '87', 'path': ['Healthcare'], 'pathIds': ['87']},
  ...
  'Hobby & Makers': {'id': '48', 'path': ['Hobby & Makers'], 'pathIds': ['48']},
  ...
  'Household': {'id': '3', 'path': ['Household'], 'pathIds': ['3']},
  ...
  'Learning': {'id': '90', 'path': ['Learning'], 'pathIds': ['90']},
  ...
  'Seasonal designs': {'id': '65', 'path': ['Seasonal designs'], 'pathIds': ['65']},
  ...
  'Sports & Outdoor': {'id': '9', 'path': ['Sports & Outdoor'], 'pathIds': ['9']},
  ...
  'Tabletop Miniatures': {'id': '101', 'path': ['Tabletop Miniatures'], 'pathIds': ['101']},
  ...
  'Toys & Games': {'id': '30', 'path': ['Toys & Games'], 'pathIds': ['30']},
  ...
  'World & Scans': {'id': '58', 'path': ['World & Scans'], 'pathIds': ['58']},
...
export function printablesIsCategorySupported(category) {
  return category in printablesCategories;
}
